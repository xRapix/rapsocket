...
[ ] v3.0.0 - No-STD / Pure Native WinAPI version – completely removing <string> and modern C++ standard library dependencies for malware analysts and low-level enthusiasts (executable size < 20KB).
